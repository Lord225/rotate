...
public class PlacedObjectAnim : MonoBehaviour
{
    ...
    void ChangeObject()
    {
        ...
        {
            CurrentMachineInstanceGhost = Prefabs.CreatePrefab(Player.ObjectInHands.type, -1, Vector2Int.FloorToInt(Utils.XZtoVector2(transform.position)));
            ...
            CurrentMachineInstanceGhost.transform.position = this.transform.position;
